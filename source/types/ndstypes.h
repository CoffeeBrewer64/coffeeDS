...
typedef struct {
    ...
    unsigned int arm9IconOffset;
    unsigned int arm9IconSize;
    unsigned int arm7IconOffset;
    unsigned int arm7IconSize;
    ...
    unsigned int arm7LoadAddress;
    unsigned char reserved4[8];
    unsigned short region;
    unsigned char reserved5[2];
    unsigned int arm9OverlayJumpTableOffset;
    unsigned int arm7OverlayJumpTableOffset;
    unsigned int reserved6[4];
    unsigned int bannerOffset;
    unsigned char reserved7[8];
    unsigned int secureTransferTimeout;
    unsigned int arm9AutoloadListRamAddressEnd;
    unsigned int arm7AutoloadListRamAddressEnd;
    unsigned char reserved8[24];
    unsigned char ntrRegionRomVersion;
    unsigned char reserved9[11];
    unsigned int defaultTiming;
    unsigned int arm9AutoloadListRamAddressMain;
    unsigned int arm7AutoloadListRamAddressMain;
    unsigned int reserved10[29];
    unsigned int filenameTableOffset;
    unsigned int filenameTableSize;
    unsigned int fileAllocationTableOffset;
    unsigned int fileAllocationTableSize;
    unsigned int filenameTable2Offset;
    unsigned int filenameTable2Size;
    unsigned int fileAllocationTable2Offset;
    unsigned int fileAllocationTable2Size;
    unsigned int bannerAnimationOffset;
    unsigned int reserved11[21];
    unsigned char ndsRegion;
    unsigned char reserved12[63];
} ndsrom_header;
